...
public class SeedData {
    ...
    private void seedLoans() {
        ...
        LoanDto loanDto1 = new LoanDto(new BigDecimal(10000), 10.0, Terms.SHORT, LocalDate.of(2025, 1, 1), LocalDate.of(2025, 6, 1), 3, 1L,1L, LoanStatus.WAITING, LoanType.EMILoan, (short) 1);
        LoanDto loanDto2 = new LoanDto(new BigDecimal(12000), 5.0, Terms.SHORT, LocalDate.of(2025, 1, 1), LocalDate.of(2025, 12, 1), 3, 1L,1L, LoanStatus.WAITING, LoanType.EMILoan, (short) 1);
